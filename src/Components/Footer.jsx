      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/help" className="text-gray-400 hover:text-primary transition-colors">Customer Service</Link></li>
              <li><Link to="/returns" className="text-gray-400 hover:text-primary transition-colors">Returns</Link></li>
              <li><Link to="/shipping" className="text-gray-400 hover:text-primary transition-colors">Shipping Info</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/mobile-app" className="text-gray-400 hover:text-primary transition-colors">Mobile App</Link></li>
              <li><Link to="/wholesale" className="text-gray-400 hover:text-primary transition-colors">Wholesale</Link></li>
              <li><Link to="/student-discount" className="text-gray-400 hover:text-primary transition-colors">Student Discount</Link></li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex space-x-2">
                {['Visa', 'Master', 'Amex', 'PayPal'].map((payment) => (
                  <div key={payment} className="bg-gray-800 px-3 py-1 rounded text-xs text-gray-400">
                    {payment}
                  </div>
                ))}
              </div>
