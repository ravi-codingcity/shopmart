...
const Saree = () => {
  ...
  // Filter products for saree category
  const sareeProducts = products.filter(product => 
    product.category === 'Saree' || product.name.toLowerCase().includes('saree')
  );
  ...
  const filteredProducts = sortedProducts.filter(product => {
    switch (priceRange) {
      ...
      case '3000-8000':
        return product.price >= 3000 && product.price <= 8000;
      case '8000-15000':
        return product.price >= 8000 && product.price <= 15000;
      case 'above-15000':
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-orange-100 mb-6">
              Discover beautiful sarees for every occasion - traditional, silk & designer
            </p>
            <nav className="flex justify-center">
              <ol className="flex items-center space-x-2 text-sm">
                ...
                <li>
                  <Link to="/women" className="text-orange-200 hover:text-white transition-colors">
                    Women
                  </Link>
                </li>
                <li className="text-orange-300">/</li>
                <li className="text-white font-medium">Saree</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="bg-gradient-to-br from-orange-100 to-red-100 rounded-xl p-6 text-center hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <h3 className="font-semibold text-gray-900">Silk Sarees</h3>
            </div>
            ...
            <div className="bg-gradient-to-br from-red-100 to-pink-100 rounded-xl p-6 text-center hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <h3 className="font-semibold text-gray-900">Cotton Sarees</h3>
            </div>
          ...
          {filteredProducts.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No sarees found</h3>
